...
/*Validationalidation Button Next*/
form.addEventListener('keyup', () => {
  ...
  txtName.removeAttribute('style', 'color: #00cc00')
  txtName.innerHTML = 'Nome Completo'
...
form.addEventListener('keyup', () => {
    ...
    txtCpf_cnpj.innerHTML = 'Número de CPF'
    nextBtnFirst.disabled = false;      
  }
   });
form.addEventListener('keyup', () => {
...
form.addEventListener('keyup', () => {
        ...
        txtPasswordRepeat.innerHTML = 'Repita a senha novamente!'
      } else{
